...
plot_profile(x, z, color="b", title="Initial Hillslope Profile", outfile="initial_profile.png")
...
plot_profile (x, z, color="y", title="Final Hillslope Profile", outfile="final_profile.png")
